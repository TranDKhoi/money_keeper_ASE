...
BudgetDetailSummary _$BudgetDetailSummaryFromJson(Map<String, dynamic> json) => BudgetDetailSummary(
      totalBudget: json['totalBudget'] as int?,
      totalSpentAmount: json['totalSpentAmount'] as int?,
      recommendedDailyExpense: (json['recommendedDailyExpense'] as num?)?.toDouble(),
      realDailyExpense: (json['realDailyExpense'] as num?)?.toDouble(),
      expectedExpense: (json['expectedExpense'] as num?)?.toDouble(),
    );

Map<String, dynamic> _$BudgetDetailSummaryToJson(BudgetDetailSummary instance) => <String, dynamic>{
