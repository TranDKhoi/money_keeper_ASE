...
class SignupController extends GetxController {
  ...
  void verifyCodeFunc() async {
    if (secureCode != null) {
      EasyLoading.show();
      var res =
          await AuthService.ins.verifyAccount(email: emailTextController.text, code: secureCode!);
      EasyLoading.dismiss();
  ...
  bool isValidData() {
    return emailTextController.text.isNotEmpty && passwordTextController.text.isNotEmpty;
  }
}
