...
class LoginController extends GetxController {
  ...
  loginFunc() async {
    if (isValidData()) {
      User u = User(email: emailTextController.text, password: passTextController.text);
  ...
  bool isValidData() {
    return emailTextController.text.isNotEmpty && passTextController.text.isNotEmpty;
  }
}
