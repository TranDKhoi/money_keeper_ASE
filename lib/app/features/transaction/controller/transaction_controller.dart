...
class TransactionController extends GetxController {
  ...
  getGlobalTransaction() async {
    EasyLoading.show();
    var res = await TransactionService.ins.getGlobalTransaction(selectedTimeLine.value!);
    EasyLoading.dismiss();
  ...
  getTransactionByWalletId() async {
    ...
    var res = await TransactionService.ins
        .getTransactionByWalletId(selectedWallet.value.id!, selectedTimeLine.value!);
    EasyLoading.dismiss();
