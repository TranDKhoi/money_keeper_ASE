...
import 'package:money_keeper/app/features/transaction/controller/transaction_controller.dart';
...
class AddTransactionController extends GetxController {
  ...
  createNewTransaction() async {
    ...
    if (pickedImage.value != null) {
      imageLink = await StorageService.ins.uploadImageToStorage(File(pickedImage.value!));
    }

    final newTran = Transaction();
    newTran.amount = int.parse(amountController.text.replaceAll(RegExp(r"\D"), "").trim());
