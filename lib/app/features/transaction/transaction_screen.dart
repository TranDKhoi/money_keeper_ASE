                      ...
                      children: [
                            ...
                            Obx(
                              () => Text(
                                FormatHelper().moneyFormat(
                                    _controller.transactionsByTime.value.totalIncome?.toDouble()),
                        ...
                        Row(
                          children: [
                            ...
                            Obx(
                              () => Text(
                                FormatHelper().moneyFormat(
                                    _controller.transactionsByTime.value.totalExpense?.toDouble()),
                                style: const TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              FormatHelper().moneyFormat(
                                  (_controller.transactionsByTime.value.totalIncome ?? 0) -
                                      (_controller.transactionsByTime.value.totalExpense ?? 0)
                                          .toDouble()),
                              style: const TextStyle(
                                fontWeight: FontWeight.bold,
                              ),
