...
import 'package:money_keeper/app/features/category/widgets/expanded_list_tile.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          child: Obx(() {
            if (_controller.currentTabIndex.value == 0) {
              return ListView.separated(
                shrinkWrap: true,
                physics: const BouncingScrollPhysics(),
                itemBuilder: (context, i) => _buildSlideItem(_controller.listIncome[i]),
              ...
              return ListView.separated(
                shrinkWrap: true,
                physics: const BouncingScrollPhysics(),
                itemBuilder: (context, i) => _buildExpandedTile(_controller.listExpenseTile[i]),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          await showDialog(context: context, builder: (context) => const AddEditCategoryScreen());
