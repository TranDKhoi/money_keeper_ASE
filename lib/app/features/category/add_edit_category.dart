...
import 'package:money_keeper/app/features/category/widgets/category_icon_modal.dart';
  ...
  void applyData() {
    if (_controller.selectedEditCategory.value != null) {
      _controller.selectedType.value =
          _controller.selectedEditCategory.value!.type == "Income" ? R.Income.tr : R.Expense.tr;
