...
class ReportLineChart extends StatelessWidget {
  ...
  Widget leftTitleWidgets(double value, TitleMeta meta) {
    ...
    return Text(_controller.dy[value.round()].toStringAsFixed(1), textAlign: TextAlign.left);
  }
  ...
  LineChartData mainData() {
    return LineChartData(
      ...
      lineBarsData: [
        ...
        LineChartBarData(
          spots: _controller.dailyReport
              .map((e) => FlSpot(e.date?.day.toDouble() as double, e.expense!.toDouble()))
              .toList(),
          isCurved: true,
          gradient: LinearGradient(
          ...
          belowBarData: BarAreaData(
            show: true,
            gradient: LinearGradient(
              colors: gradientColorsRed.map((color) => color.withOpacity(0.3)).toList(),
            ),
          ),
        ),
      ],
