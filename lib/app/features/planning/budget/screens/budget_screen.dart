...
import 'package:money_keeper/app/features/planning/budget/widget/budget_item.dart';
import 'package:money_keeper/app/features/planning/budget/widget/summary_card.dart';
...
class _BudgetScreenState extends State<BudgetScreen> with SingleTickerProviderStateMixin {
  ...
  @override
  void initState() {
    _tabController = TabController(length: budgetController.listTimeline.length, vsync: this);
                        ...
                        itemBuilder: (context, i) => InkWell(
                          onTap: () async {
                            await budgetController.initBudgetInfoScreenData(
                                budgetId: budgetController.budgets[i].id as int);
                            Get.toNamed(budgetInfoScreen);
                          },
                          child: BudgetItem(budget: budgetController.budgets[i]),
                        ),
