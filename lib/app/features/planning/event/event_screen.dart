...
class EventScreen extends StatefulWidget {
  const EventScreen({Key? key, this.canChangeWallet = true, this.selectedWallet}) : super(key: key);
  ...
  _buildEventItem(Event e) {
    return Card(
      child: InkWell(
        onTap: () {
          if (widget.selectedWallet == null) {
            Get.toNamed(eventInfoScreenRoute, arguments: e)
                ?.then((value) => _controller.changeEventTabBar(_tabController.index));
          } else {
            Get.back(result: e);
          }
        },
