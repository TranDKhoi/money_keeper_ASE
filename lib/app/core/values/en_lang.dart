...
const Map<String, String> enLanguagePackage = {
  ...
  R.VERIFY: "Verify",
  R.Didntreceiveanycode: "I haven't received the OTP Code",
  R.Signin: "Sign in",
  R.Password: "Password",
  R.SIGNIN: "SIGN IN",
  ...
  R.Cutunnecessaryexpenses: "Reduce unnecessary expenses",
  R.Increasesavingssteadilyeverymonth: "Save money every month",
  R.Manageitallinoneplace: "All are managed in one place",
  R.SIGNUPFORFREE: "Sign up free",
  R.Home: "Home",
